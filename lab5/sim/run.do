...
# Load project
  ...
  eval vsim -novopt -quiet -nocoverage +notimingchecks +nowarnTSCALE -sva -G/top/test/NUMBER_OF_TRANSACTIONS=$2 -G/top/test/NUMBER_OF_TRANSACTIONS=$3 -G/top/test/NUMBER_OF_TRANSACTIONS=$4
