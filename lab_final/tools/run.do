...
# Load project
  eval vsim -novopt -quiet -nocoverage +notimingchecks +nowarnTSCALE -sva  -G/top/test/test_name=$1 -G/top/test/NUMBER_OF_TRANSACTIONS=$2 -G/top/test/RANDOM_CASE=$3 -G/top/test/seed=$4 top
